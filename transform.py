...
columns_map = {
    ...
    'AEROPORTO DE DESTINO (SIGLA)': 'destination_airpot_abbreviation',
    'AEROPORTO DE DESTINO (NOME)': 'destination_airpot_name',
    'AEROPORTO DE DESTINO (UF)': 'destination_airpot_state',
    'AEROPORTO DE DESTINO (REGIÃO)': 'destination_airpot_region',
    'AEROPORTO DE DESTINO (PAÍS)': 'destination_airpot_country',
    'AEROPORTO DE DESTINO (CONTINENTE)': 'destination_airpot_continent',
    'NATUREZA': 'nature',
